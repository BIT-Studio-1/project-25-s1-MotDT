...
namespace Studio_1
{
    internal class Program
    {
        ...
        static void Main()
        {
            ...
            PrintDelayed($"{CYAN}PLEASE FULLSCREEN [{GREEN}F11{CYAN}] THE CONSOLE FOR A BETTER EXPERIENCE{RESET}");
        ...
        static void EndPrompts() // method to stop repeated code/tidy up code
        {
